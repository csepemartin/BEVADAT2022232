...
# %%
def set_one(input_array=np.array([[1,2],[3,4]])):
...
# %%
def do_transpose(input_array=np.array([[1,2],[3,4]])):
...
# %%
def round_array(input_array=np.array([0.1223,0.1675]),n = 2):
...
# %%
def bool_array(input_array=np.array([[1, 0, 0], [1, 1, 1],[0, 0, 0]])):
...
# %%
def invert_bool_array(input_array=np.array([[1, 0, 0], [1, 1, 1],[0, 0, 0]])):
    return input_array==0
...
# %%
def flatten(input_array=np.array([[1,2],[3,4]])):
